...
import { checkPermissions, createDateFormatter, fetchGuild, formatBoolean, imageField, startCase, startCaseFromParts } from '../../utils.js';
const command = {
                    ...
                    fields: [
                        ...
                        ...(systemChannelFlags.has([
                            ...
                            : await channelFieldData('System Messages Channel', systemChannelId, () => ` (${systemChannelFlags
                                ...
                                .map(string => startCaseFromParts(string.toLowerCase().split('_').slice(1)))
                                .join(', ')})`)),
                        ...(widgetEnabled ?? false
                            ...
                            : []),
                        {
                            ...
                            value: defaultMessageNotifications === 'ALL_MESSAGES'
                                ? 'All Messages'
                                : 'Only @mentions'
                        },
                        {
